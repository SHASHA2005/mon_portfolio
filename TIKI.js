...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Fix bouton retour mobile — attaché après génération du DOM
    document.querySelectorAll('.back-to-front').forEach(btn => {
            ...
            <div class="flip-card-inner" id="inner-${project.id}">
                ...
                <div class="flip-card-face face-3">
                    <div class="gallery-container">
                        ...
                        <button class="back-to-front" id="back-btn-${project.id}">
...
// ===== PARTICULES EN FORME DE CŒUR SUR TOUT LE PORTFOLIO =====
